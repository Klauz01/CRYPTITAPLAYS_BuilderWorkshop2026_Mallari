...
| Camera export | After a successful object load, click **Camera** → PNG downloads at **1080×1350** (4:5): tilted front above tilted back on stylized gradient + pattern; no keychain |
